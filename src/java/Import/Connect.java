...
public class Connect extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String st="no";HttpSession se=request.getSession();  
            System.out.println("sess:"+se.getAttribute("name"));
             if(se.getAttribute("name")==null)  {
            if(un!=""&&pass!=""){
              st=l.check(un, pass);
            }
            System.out.println("LOG IN:  "+st);
            if(st!="no"){
                HttpSession session=request.getSession();  
                session.setAttribute("name",st);  
                System.out.println("LOG IN SUCCESS "+st);
